...
type ColumnType = ColumnDef<IdeaInterface, unknown>;

interface IdeaListPageProps {
...
export function IdeaListPage(props: IdeaListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<IdeaInterface>>(
    () => `/ideas?params=${JSON.stringify(params)}`,
    fetcher,
  );
      ...
      : null,
    {
      ...
      cell: ({ row: { original: record } }: any) => (
        <Flex justifyContent="flex-end">
          <NextLink href={`/ideas/view/${record.id}`} passHref legacyBehavior>
            <Button
